  ...
  return (
    ...
    <div className="h-[80vh] w-full rounded-md bg-neutral-950 relative flex flex-col lg:flex-row items-center justify-center antialiased">
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <h1 className="relative z-10 text-3xl md:text-4xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans font-bold">
          Target Audience
        </h1>
        <p></p>

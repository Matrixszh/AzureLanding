  ...
  return (
    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      ...
      <WobbleCardDemo />
        ...
        <div>
  <h1
    className="text-justify flex text-4xl lg:text-6xl font-bold justify-center py-4 items-center 
    bg-gradient-to-b from-gray-500 via-gray-400 to-gray-100 bg-clip-text text-transparent"
  >
    Global Coverage
  </h1>
  <h1 className="mt-4 text-center font-light text-sm md:text-lg text-neutral-600 dark:text-white">
